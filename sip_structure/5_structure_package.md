...
| Datatype | [OR-id]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#or-id) |
| Cardinality | 0..1 |
| Obligation | MAY |
...
| Datatype | [IANA mime type]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#mimetype) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string); fixed vocabulary (e.g. [`PREMIS standard identifiers`](https://id.loc.gov/vocabulary/identifiers.html)) |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:objectIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:relatedObjectIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:eventIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string); fixed vocabulary (e.g. [`PREMIS event outcome`](https://id.loc.gov/vocabulary/preservation/eventOutcome.html)) |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:linkingAgentIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:linkingObjectIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string); fixed vocabulary from [`PREMIS Event Related Object Role`](http://id.loc.gov/vocabulary/preservation/eventRelatedObjectRole))  |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string) (depending on the value of the `premis:agentIdentifierType`) |
| Cardinality | 1..1 |
| Obligation | MUST |
...
| Datatype | [String]({{ site.baseurl }}{% link docs/diginstroom/sip/2.1/2_terminology.md %}#string); fixed vocabulary from [PREMIS Agent Type](https://id.loc.gov/vocabulary/preservation/agentType.html) |
