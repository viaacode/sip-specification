...
| <a id="unique-lang-strings"></a>Unique language strings         | A set of languag-tagged strings. A language tag may only appear once within a unique language-tagged string set. |
