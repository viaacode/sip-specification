...
| <a id="lang-strings"></a>Language strings         | A set of language-tagged strings. Each element containg the string datatype must have the `xml:lang` attribute, indicating the language of the string.  |
| <a id="unique-lang-strings"></a>Unique language strings         | A set of language-tagged strings. A language tag may only appear once within a unique language-tagged string set. |
